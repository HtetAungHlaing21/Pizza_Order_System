                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle" id="cartTable">
                        @foreach ($carts as $cart)
                            <tr id="details">
                                <td class="align-middle img-thumbnail col-2"><img src="{{ asset('Storage/' . $cart->product_image) }}" alt="Pizza Image"
                                        style="width: 50px;"></td>
                                ...
                                <td class="align-middle">
                                    <div class="input-group quantity mx-auto" style="width: 100px;">
                                        ...
                                        <input type="text"
                                            class="form-control form-control-sm bg-outline-warning border-0 text-center" id="qty"
                                            value={{$cart->quantity}}>
                                        <div class="input-group-btn">
                                ...
                                <td class="align-middle col-2" id="total"> {{$cart->product_price * $cart->quantity}} Ks</td>
